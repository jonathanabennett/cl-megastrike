(
	define (
		script-fu-megamek-small-unit-shading
		image
		original-layer
	)
...
(
	script-fu-register "script-fu-megamek-small-unit-shading"
		_"_Megamek Small Unit Shading..."
...
(script-fu-menu-register "script-fu-megamek-small-unit-shading"
